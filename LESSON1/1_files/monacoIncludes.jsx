...
helpMacro: getMessage("/*The Syntax Editor macros are:\n-----------------------------"),
		...
		this.accessKey = this.options.accessKey.replace("CTRL", getMessage("Ctrl")).replace("SHIFT", getMessage("Shift")).replace("OPT", getMessage("Alt")).replace("ALT", getMessage("Alt")).replace(" + ", getMessage("-")).replace("Cmd", getMessage("Cmd"));
...
return true;
	...
	getExtraKeyMap: function() {
		...
		return {
			...
			"fullScreen": getMessage("Ctrl-M"),
			"find": new GwtMessage().getMessage("{0}-F", accessKey),
			"findNext": getMessage("Enter"),
			"findPrev": getMessage("Shift-Enter"),
			"formatCode": getMessage("Shift-Alt-F"),
			"replace": new GwtMessage().getMessage("{0}-Alt-F", accessKey),
			"replaceAll": new GwtMessage().getMessage("{0}-Alt-F", accessKey),
"commentSelection": new GwtMessage().getMessage("{0}-/", accessKey)
		}
	},
	toString: function () {
...
this.editorCacheWorker = new SharedWorker("scripts/classes/monaco/editorCacheWorker.js?v=07-27-2025_1301&sysparm_substitute=false");
...
var autoCompleteWorker = new SharedWorker("scripts/classes/monaco/autoCompleteWorker.js?v=07-27-2025_1301&sysparm_substitute=false");
...
var discoverWorker = new SharedWorker("scripts/classes/monaco/discoverWorker.js?v=07-27-2025_1301&sysparm_substitute=false");
...
var linterUrl = "/scripts/snc-code-editor/eslint_bundle.min.js?v=07-27-2025_1301&sysparm_substitute=false";
var scriptUrl = "scripts/classes/monaco/lintWorker.js?v=07-27-2025_1301&sysparm_substitute=false";
